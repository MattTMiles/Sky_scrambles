...
Omega_str = '/fred/oz002/vdimarco/sky_scrambles/sensitivity_curves/PPTA_Omega_t\
hin.csv' 
f_str = '/fred/oz002/vdimarco/sky_scrambles/sensitivity_curves/PPTA_frequencies\
_thin.csv'
Pij_str = '/fred/oz002/vdimarco/sky_scrambles/sensitivity_curves/PPTA_S_I_thin.\
csv'
...
m, n_a, n_i, c = get_scrambles(orf_true[1], Omega, f, Pij, 100, 0.1)

print(c)

pd.DataFrame(c).to_csv('/fred/oz002/vdimarco/sky_scrambles/skies/results/n_tries_many_mod.csv', header=None, index=None) 
