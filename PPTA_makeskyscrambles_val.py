...
m, n_a, n_i, c = get_scrambles(orf_true[1], Omega, f, Pij, 3000, 0.1)

print(c)

pd.DataFrame(c).to_csv('/fred/oz002/vdimarco/sky_scrambles/skies/results/n_tries_many.csv', header=None, index=None) 
