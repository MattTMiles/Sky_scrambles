...
f_str = '/fred/oz002/vdimarco/sky_scrambles/skies/sensitivity_curves/results/NANOGrav_frequencies.csv'
Pij_str = '/fred/oz002/vdimarco/sky_scrambles/skies/sensitivity_curves/results/NANOGrav_S_I.csv'
...
m, n_a, n_i, c = get_scrambles(Omega, f, Pij, 10, 0.1)

print(c)

pd.DataFrame(c).to_csv('/fred/oz002/vdimarco/sky_scrambles/skies/results/NANOGrav_n_tries_10_mod.csv', header=None, index=None) 
